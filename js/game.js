...
if (score < 12 && score > 9) { this.add.text(300, 500, 'Ничё так!', { fontSize: '40px', fill: '#FFF' }); };
if (score < 20 && score > 11) { this.add.text(300, 500, 'Нормально!', { fontSize: '40px', fill: '#FFF' }); };
...
if (score < 10 && score > 7) { this.add.text(100, 500, 'Ни холоден, ни горяч...', { fontSize: '40px', fill: '#FFF' }); };
// гейм овер экран
